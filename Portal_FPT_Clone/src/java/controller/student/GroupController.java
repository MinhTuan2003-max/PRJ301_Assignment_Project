...
public class GroupController extends BaseRequiredAuthenticationController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, Account loggedAccount)
        ...
        int semester_id = (request.getParameter("semester_id") != null) ? Integer.parseInt(request.getParameter("semester_id")) : gnd.getDefaultIfNull(request.getSession().getAttribute("semester_id"), semesters.size());
        ...
        int department_id = (request.getParameter("department_id") != null) ? Integer.parseInt(request.getParameter("department_id")) : gnd.getDefaultIfNull(request.getSession().getAttribute("department_id"), 1);
        ...
        int course_id = (request.getParameter("course_id") != null) ? Integer.parseInt(request.getParameter("course_id")) : gnd.getDefaultIfNull(request.getSession().getAttribute("course_id"), 0);
        ...
        int group_id = (request.getParameter("group_id") != null) ? Integer.parseInt(request.getParameter("group_id")) : gnd.getDefaultIfNull(request.getSession().getAttribute("group_id"), 0);
